...
const Hero = () => {
  return (
    <section id="home" className="pt-24 pb-16 px-6 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-300 max-w-2xl leading-relaxed">
                Expert full-stack engineer specializing in backend development with 4+ years of experience in 
                Node.js, Nest.js, microservices architecture, and scalable system design. 
                Proven track record of leading teams and delivering high-performance applications.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-white/5 rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="font-semibold">kumbarsachin67@gmail.com</div>
                  </div>
                </div>
